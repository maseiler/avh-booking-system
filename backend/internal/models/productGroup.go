...
// It executes the SQL statement generated by the query and returns all matching product groups.
...
func (m *ProductGroupModel) Get(query *Query) ([]ProductGroup, error) {
	...
	groups, err := pgx.CollectRows(rows, pgx.RowToStructByName[ProductGroup])
	if err != nil {
