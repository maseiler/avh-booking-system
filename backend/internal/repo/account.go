...
// AccountStore provides database operations for Account entities.
type AccountStore struct {
	DB DBTx
}

// Get retrieves accounts based on the provided query specification.
func (m *AccountStore) Get(ctx context.Context, query *Query) ([]models.Account, error) {
...
func (m *AccountStore) GetByID(ctx context.Context, id int) (*models.Account, error) {
...
func (m *AccountStore) Insert(ctx context.Context, account models.Account) (int, error) {
	query := `
...
func (m *AccountStore) Update(ctx context.Context, account models.Account) (int, error) {
	query := `
        UPDATE account
