...
func main() {
	...
	r.HandleFunc("/getItemCategories", handler.GetItemCategories)
	r.HandleFunc("/addItemCategory", handler.AddItemCategory)
	r.HandleFunc("/deleteItemCategory", handler.DeleteItemCategory)
	r.HandleFunc("/getItemCategoryMaps", handler.GetItemCategoryMaps)
	r.HandleFunc("/addItemCategoryMap", handler.AddItemCategoryMap)
	r.HandleFunc("/deleteItemCategoryMap", handler.DeleteItemCategoryMap)
	r.HandleFunc("/getLastNBookings", handler.GetLastNBookings)
	r.HandleFunc("/getBookingsFromUserBetween", handler.GetBookingsFromUserBetween)
	r.HandleFunc("/getBookingsFromItemBetween", handler.GetBookingsFromItemBetween)
